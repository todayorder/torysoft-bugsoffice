...
<head>
	<meta charset="utf-8" />
	<title>Bug's Office | Bug Management Solution</title>
	...
	<link href="<c:url value="/resources/front/plugins/bootstrap/css/bootstrap.min.css"/>" rel="stylesheet" />
	<link href="<c:url value="/resources/front/plugins/font-awesome/css/font-awesome.min.css"/>" rel="stylesheet" />
	<link href="<c:url value="/resources/front/css/style.min.css"/>" rel="stylesheet" />
	<link href="<c:url value="/resources/front/css/style-responsive.min.css"/>" rel="stylesheet" />
	<link href="<c:url value="/resources/front/css/theme/default.css"/>" id="theme" rel="stylesheet" />
	<link href="<c:url value="/resources/front/css/animate.min.css"/>" rel="stylesheet" />
	<link href="<c:url value="/resources/front/css/bugoffice-front.css"/>" rel="stylesheet" />
	<!-- ================== END BASE CSS STYLE ================== -->
	
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="<c:url value="/resources/front/plugins/pace/pace.min.js"/>"></script>
	<!-- ================== END BASE JS ================== -->
</head>
<body>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="dropdown dropdown-hover">
                            <a href="#" data-toggle="dropdown"><img src="<c:url value="/resources/front/img/english.png"/>" class="flag-img" alt="" /> English <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="?lang=en_US"><img src="<c:url value="/resources/front/img/english.png"/>" class="flag-img" alt="" /> English</a></li>
                                <li><a href="?lang=ko_KR"><img src="<c:url value="/resources/front/img/english.png"/>" class="flag-img" alt="" /> 한국어</a></li>
                                <li><a href="#"><img src="<c:url value="/resources/front/img/chinese.png"/>" class="flag-img" alt="" /> Chinese</a></li>
                            </ul>
                        </li>
                ...
                <div class="header-container">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="header-logo">
                            <a href="<c:url value="/front"/>">
                                <img class="icon" alt="" src="<c:url value="/resources/front/img/iconmonstr-bug-track-2-icon-256.png"/>">
                                <span>Bug's</span> Office
                                <small>bug management solution</small>
                            </a>
                        </div>
                    </div>
                    <!-- END navbar-header -->
                    ...
                    <div class="header-nav">
                        <div class=" collapse navbar-collapse" id="navbar-collapse">
                            <ul class="nav">
                                <li class="active"><a href="<c:url value="/front"/>">Home</a></li>
                                        ...
                                        <div class="dropdown-menu-container">
                                            ...
                                            <div class="dropdown-menu-content">
                                                ...
                                                <ul class="dropdown-brand-list m-b-0">
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/apple.png"/>" alt="" /></a></li>
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/samsung.png"/>" alt="" /></a></li>
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/htc.png"/>" alt="" /></a></li>
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/microsoft.png"/>" alt="" /></a></li>
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/nokia.png"/>" alt="" /></a></li>
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/blackberry.png"/>" alt="" /></a></li>
                                                    <li><a href="product.html"><img src="<c:url value="/resources/front/img/sony.png"/>" alt="" /></a></li>
                                                </ul>
                                            </div>
                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown dropdown-hover">
                                ...
                                <div class="dropdown-menu dropdown-menu-cart p-0">
                                    ...
                                    <div class="cart-body">
                                        <ul class="cart-item">
                                            <li>
                                                <div class="cart-item-image"><img src="<c:url value="/resources/front/img/ipad.jpg"/>" alt="" /></div>
                                            ...
                                            <li>
                                                <div class="cart-item-image"><img src="<c:url value="/resources/front/img/imac.jpg"/>" alt="" /></div>
                                                <div class="cart-item-info">
                                            ...
                                            <li>
                                                <div class="cart-item-image"><img src="<c:url value="/resources/front/img/iphone.png"/>" alt="" /></div>
                                                <div class="cart-item-info">
                            ...
                            <li>
                                <a href="my_account.html">
                                    <img src="<c:url value="/resources/front/img/user-1.jpg"/>" class="user-img" alt="" /> 
            ...
            <div id="main-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner"> 
                    ...
                    <div class="item active">
                        <img src="<c:url value="/resources/front/img/slider-1-cover.jpg"/>" class="bg-cover-img" alt="" />
                        <div class="container">
                            <img src="<c:url value="/resources/front/img/slider-1-product.png"/>" class="product-img right bottom fadeInRight animated" alt="" />
                        </div>
                    ...
                    <!-- BEGIN item -->
                    <div class="item">
                        <img src="<c:url value="/resources/front/img/slider-2-cover.jpg"/>" class="bg-cover-img" alt="" />
                        <div class="container">
                            <img src="<c:url value="/resources/front/img/slider-2-product.png"/>" class="product-img left bottom fadeInLeft animated" alt="" />
                        </div>
                    ...
                    <!-- BEGIN item -->
                    <div class="item">
                        <img src="<c:url value="/resources/front/img/slider-3-cover.jpg"/>" class="bg-cover-img" alt="" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="promotion promotion-lg bg-black-darker">
                            <div class="promotion-image text-right promotion-image-overflow-bottom">
                                <img src="<c:url value="/resources/front/img/iphone-se.png"/>" alt="" />
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="promotion bg-blue">
                            <div class="promotion-image promotion-image-overflow-bottom promotion-image-overflow-top">
                                <img src="<c:url value="/resources/front/img/apple-watch-sm.png"/>" alt="" />
                            </div>
                        ...
                        <div class="promotion bg-silver">
                            <div class="promotion-image text-center promotion-image-overflow-bottom">
                                <img src="<c:url value="/resources/front/img/mac-mini.png"/>" alt="" />
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="promotion bg-silver">
                            <div class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-right">
                                <img src="<c:url value="/resources/front/img/mac-accessories.png"/>" alt="" />
                            </div>
                            <div class="promotion-caption text-center">
                        ...
                        <div class="promotion bg-black">
                            <div class="promotion-image text-right">
                                <img src="<c:url value="/resources/front/img/mac-pro.png"/>" alt="" />
                            </div>
                            <div class="promotion-caption promotion-caption-inverse">
            ...
            <div class="container">
                ...
                <div class="row row-space-10">
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="<c:url value="/resources/front/img/iphone.png"/>" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="<c:url value="/resources/front/img/ipad-pro.png"/>" alt=""  />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="<c:url value="/resources/front/img/imac.png"/>" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="<c:url value="/resources/front/img/apple-watch.png"/>" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="<c:url value="/resources/front/img/macbook-pro.png"/>" alt="" />
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img src="<c:url value="/resources/front/img/apple-tv.png"/>" alt="" />
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img src="<c:url value="/resources/front/img/samsung-s7-edge.jpg"/>" alt="" />
                                </div>
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/samsung-note5.png"/>" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/zenfone2.png"/>" alt="" />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/xperia-z.png"/>" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/lumia-532.png"/>" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                ...
                <div class="category-container">
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img src="<c:url value="/resources/front/img/huawei-mediapad.jpg"/>" alt="" />
                                </div>
                                <div class="item-info bottom">
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/galaxy-tab2.png"/>" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/galaxy-taba.png"/>" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/hp-spectrex2.png"/>" alt="" />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/xperia-z2.png"/>" alt="" />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                ...
                                <div class="item item-thumbnail">
                                    <a href="product_detail.html" class="item-image">
                                        <img src="<c:url value="/resources/front/img/ipad-air.png"/>" alt="" />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="list-unstyled list-product">
                            <li>
                                <div class="image">
                                    <img src="<c:url value="/resources/front/img/iphone-6s.jpg"/>" alt="" />
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="image">
                                    <img src="<c:url value="/resources/front/img/galaxy-s6.jpg"/>" alt="" />
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="image">
                                    <img src="<c:url value="/resources/front/img/ipad-pro.jpg"/>" alt="" />
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="image">
                                    <img src="<c:url value="/resources/front/img/galaxy-note5.jpg"/>" alt="" />
                                </div>
                                <div class="info">
        ...
        <div id="footer-copyright" class="footer-copyright">
            ...
            <div class="container">
                <div class="payment-method">
                    <img src="<c:url value="/resources/front/img/payment_method.png"/>" alt="" />
                </div>
                <div class="copyright">
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script src="<c:url value="/resources/front/plugins/jquery/jquery-1.9.1.min.js"/>"></script>
	<script src="<c:url value="/resources/front/plugins/jquery/jquery-migrate-1.1.0.min.js"/>"></script>
	<script src="<c:url value="/resources/front/plugins/bootstrap/js/bootstrap.min.js"/>"></script>
	<!--[if lt IE 9]>
		<script src="<c:url value="/resources/front/crossbrowserjs/html5shiv.js"/>"></script>
		<script src="<c:url value="/resources/front/crossbrowserjs/respond.min.js"/>"></script>
		<script src="<c:url value="/resources/front/crossbrowserjs/excanvas.min.js"/>"></script>
	<![endif]-->
	<script src="<c:url value="/resources/front/plugins/jquery-cookie/jquery.cookie.js"/>"></script>
	<script src="<c:url value="/resources/front/js/apps.min.js"/>"></script>
	<!-- ================== END BASE JS ================== -->
